...
class RoleSeeder extends Seeder
{
    ...
    private array $roles = [
        ...
        'organization-admin' => [
            ...
            'permissions' => ['organization.*', 'store.*', 'users.*', 'roles.*', 'apps.*', 'webhooks.*', 'sync.*', 'alerts.*', 'finance.*', 'reports.*', 'student_discount.*', 'products.sync', 'orders.sync', 'customers.sync', 'inventory.sync', '*.view'],
        ],
        'store-admin' => [
            'name' => '店铺管理员',
            'description' => '管理指定店铺及其日常业务运营。',
            'permissions' => ['store.view', 'store.update', 'store.connect', 'store.disconnect', 'orders.*', 'products.*', 'customers.*', 'inventory.*', 'webhooks.*', 'sync.*', 'alerts.*', 'reports.*', 'student_discount.*'],
        ],
        'developer' => [
            'name' => '开发人员',
        ...
        'operator' => [
            ...
            'permissions' => ['orders.view', 'orders.update', 'products.view', 'products.update', 'customers.view', 'inventory.view', 'sync.view', 'reports.view', 'reports.export', 'student_discount.claim.read', 'student_discount.view_evidence', 'student_discount.approve', 'student_discount.reject', 'student_discount.analytics.read'],
        ],
        'marketing' => [
            'name' => '营销人员',
