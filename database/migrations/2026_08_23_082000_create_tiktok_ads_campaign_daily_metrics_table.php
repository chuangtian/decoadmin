...
return new class extends Migration
{
    ...
    {
        Schema::create('tiktok_ads_campaign_daily_metrics', function (Blueprint $table): void {
            $table->id();
            ...
            $table->string('objective_type', 100)->nullable();
            ...
            $table->unique(
                ...
                'tiktok_campaign_daily_store_unique',
            );
            $table->index(['organization_id', 'store_id', 'metric_date'], 'tiktok_campaign_daily_scope_date');
            $table->foreign('advertising_channel_account_id', 'tiktok_campaign_daily_account_fk')
    ...
    {
        Schema::dropIfExists('tiktok_ads_campaign_daily_metrics');
    }
};
