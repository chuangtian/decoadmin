...
return new class extends Migration
{
    ...
    {
        Schema::create('bing_ads_campaign_daily_metrics', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(
                ...
                'bing_campaign_daily_store_unique',
            );
            $table->index(['organization_id', 'store_id', 'metric_date'], 'bing_campaign_daily_scope_date');
            $table->foreign('advertising_channel_account_id', 'bing_campaign_daily_account_fk')
    ...
    {
        Schema::dropIfExists('bing_ads_campaign_daily_metrics');
    }
};
