...
type Placement = 'homepage' | 'product_page' | 'cart_page' | 'smart_cart' | 'checkout' | 'thank_you';
...
const props = defineProps<{
    ...
    checkout: { uuid: string | null; strategy_uuid: string | null; thank_you: { uuid: string | null; strategy_uuid: string | null; heading: string; enabled: boolean }; trust_items: CheckoutTrustItem[]; icon_options: Array<{ value: string; label: string }> };
