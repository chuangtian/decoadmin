                    ...
                    <div>
                        ...
                        <div class="mt-4 grid gap-4 lg:grid-cols-2">
                            ...
                            <section class="rounded-xl border border-violet-200 bg-violet-50/30 p-4">
                                <div class="flex items-center gap-2"><span class="h-2 w-2 rounded-full bg-violet-500"></span><h4 class="text-sm font-semibold text-slate-800">写入能力</h4><span class="rounded bg-violet-100 px-2 py-0.5 text-[10px] font-semibold text-violet-700">需二次确认</span></div>
                                <div class="mt-3 space-y-2">
