    ...
    <AppLayout :breadcrumbs="[{ label: '店铺设置' }, { label: '飞书设置' }]">
        <div class="mx-auto max-w-5xl space-y-6">
            <header>
                ...
                <p class="mt-2 text-sm text-slate-500">飞书开放平台应用由所有店铺共享；店铺异常告警仅发送站内通知。</p>
            </header>
            ...
            <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                <header class="border-b border-slate-100 px-5 py-5 sm:px-7">
                    ...
                    <p class="mt-2 text-sm leading-6 text-slate-500">机器人配置按店铺保存。店铺异常告警不会发送到飞书群，仅站内通知超级管理员和技术人员。</p>
                </header>
