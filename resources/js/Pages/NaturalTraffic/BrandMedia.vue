            ...
            <template v-else>
                ...
                <template v-else-if="activeTab === 'weekly'">
                    ...
                    <template v-if="selectedWeeklyReport">
                        ...
                        <div class="grid gap-6 xl:grid-cols-2">
                            <section class="rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm"><h2 class="mb-5 text-base font-black text-slate-950">浏览 TOP 5</h2><NaturalTrafficDataTable :columns="['account_handle', 'title', 'views', 'likes', 'comments', 'permalink']" :rows="selectedWeeklyReport.top_views" :labels="postLabels" /></section>
                            <section class="rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm"><h2 class="mb-5 text-base font-black text-slate-950">互动 TOP 5</h2><NaturalTrafficDataTable :columns="['account_handle', 'title', 'views', 'likes', 'comments', 'permalink']" :rows="selectedWeeklyReport.top_engagement" :labels="postLabels" /></section>
                        </div>
