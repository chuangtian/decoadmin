...
const dateLabel = (value: string | null) => formatDateTime(value, props.event.data.store.timezone);
...
const retry = () => {
    if (window.confirm('确认将这个失败的 Webhook 事件重新加入处理队列吗？')) {
