        ...
        <section class="overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-sm">
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                    <div class="min-w-0">
                        <div class="flex flex-wrap items-center gap-2">
                            <span class="rounded-md bg-emerald-600 px-2.5 py-1 text-xs font-black uppercase tracking-[0.16em] text-white">GA4 本地快照</span>
            ...
            <div class="px-5 py-5 lg:px-6">
                <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-[minmax(240px,1.1fr)_minmax(135px,.72fr)_minmax(135px,.72fr)_minmax(120px,.58fr)_minmax(96px,auto)] xl:items-end">
                    ...
                    <label for="ga4-date-from" class="text-xs font-black uppercase tracking-[0.12em] text-slate-400">开始日期<input id="ga4-date-from" v-model="filters.date_from" name="ga4_date_from" type="date" class="mt-1.5 block h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-bold tracking-normal text-slate-800 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"></label>
                    <label for="ga4-date-to" class="text-xs font-black uppercase tracking-[0.12em] text-slate-400">结束日期<input id="ga4-date-to" v-model="filters.date_to" name="ga4_date_to" type="date" class="mt-1.5 block h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-bold tracking-normal text-slate-800 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"></label>
                    <label for="ga4-comparison" class="text-xs font-black uppercase tracking-[0.12em] text-slate-400">对比<select id="ga4-comparison" v-model="filters.comparison" name="ga4_comparison" class="mt-1.5 block h-11 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm font-bold tracking-normal text-slate-800 outline-none transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"><option value="previous">上一周期</option><option value="year">去年同期</option><option value="none">不对比</option></select></label>
