...
const width = 1000;
const height = 300;
const padding = { left: 88, right: 28, top: 32, bottom: 50 };
...
<template>
    <div v-if="items.length" class="w-full overflow-hidden">
        ...
        <svg v-readable-chart :viewBox="`0 0 ${width} ${height}`" class="block min-w-[640px] w-full" role="img" aria-label="本周与上周指标柱状对比图">
