...
use App\Services\InstagramFeed\InstagramFeedWebhookService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class ShopifyInstagramFeedWebhookController extends Controller
{
    public function __invoke(Request $request, InstagramFeedWebhookService $webhooks): JsonResponse
    {
        try {
