...
#[Fillable([
    ...
    'dimension_key', 'source_type', 'search_term', 'normalized_search_term', 'status', 'matched_keyword',
    'match_type', 'campaign_id', 'campaign_name', 'ad_group_id', 'ad_group_name', 'advertising_channel_type',
    'spend', 'revenue', 'impressions', 'clicks', 'conversions', 'raw_payload', 'synced_at',
])]
class GoogleAdsSearchTermDailyMetric extends Model
{
