...
#[Fillable([
    ...
    'campaign_id', 'campaign_name', 'campaign_status', 'objective_type', 'metric_date',
    'spend', 'attributed_sales', 'impressions', 'clicks', 'conversions', 'raw_payload', 'synced_at',
])]
class TikTokAdsCampaignDailyMetric extends Model
{
    use ScopesToOrganizationStore;

    protected $table = 'tiktok_ads_campaign_daily_metrics';
