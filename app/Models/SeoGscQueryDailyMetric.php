...
#[Fillable(['organization_id', 'store_id', 'metric_date', 'segment', 'query_id', 'query_hash', 'query', 'clicks', 'impressions', 'average_position', 'synced_at'])]
class SeoGscQueryDailyMetric extends Model
{
