...
#[Fillable(['organization_id', 'store_id', 'metric_date', 'search_type', 'dimension', 'value_hash', 'value', 'clicks', 'impressions', 'average_position', 'synced_at'])]
class SeoGscBreakdownDailyMetric extends Model
{
