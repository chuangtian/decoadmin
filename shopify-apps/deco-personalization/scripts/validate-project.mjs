...
const requiredFiles = [
  ...
  'extensions/checkout-trust-badges/package.json',
  'extensions/checkout-trust-badges/shopify.d.ts',
  'extensions/checkout-trust-badges/shopify.extension.toml',
  'extensions/checkout-trust-badges/src/TrustBadges.jsx',
  'extensions/checkout-trust-badges/src/runtime.mjs',
  'extensions/checkout-trust-badges/tsconfig.json',
  'extensions/checkout-recommendations/package.json',
  'extensions/checkout-recommendations/shopify.d.ts',
  'extensions/checkout-recommendations/shopify.extension.toml',
  'extensions/checkout-recommendations/src/Recommendations.jsx',
  'extensions/checkout-recommendations/src/runtime.mjs',
  'extensions/checkout-recommendations/tsconfig.json',
