...
- The configuration endpoint is read from the current app installation metafield `deco_personalization.checkout_configuration_url`; the extension does not hardcode a Test or Production origin.
