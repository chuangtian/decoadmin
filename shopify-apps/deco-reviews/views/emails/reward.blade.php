...
<p style="margin:24px 0 8px;font-size:14px;color:#475569">Your one-use reward code</p>
<p style="margin:0;padding:16px;border:2px dashed {{ $accent }};border-radius:12px;text-align:center;font-size:22px;font-weight:bold;letter-spacing:1px">{{ $code }}</p>
<p style="font-size:14px;color:#475569">Expires {{ $expires }}.</p>
