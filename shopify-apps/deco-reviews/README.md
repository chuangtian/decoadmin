...
The theme block now exposes isolated storefront branding controls for grid/list/mosaic layout, three corner styles, stars, buttons, card surfaces and text. Runtime and theme-editor labels are complete for English, Simplified Chinese, German, French and Spanish; these built-in translations do not claim merchant-managed per-locale custom copy.
