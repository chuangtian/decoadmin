...
type RewardHistory = { uuid: string; media_kind: 'photo' | 'video'; discount_kind: 'percentage' | 'fixed' | 'free_shipping'; value: string | null; currency: string | null; status: string; review_title?: string | null; product_title?: string | null; due_at?: string | null; issued_at?: string | null; expires_at?: string | null; created_at: string; error_code?: string | null; email_status?: string | null; email_sent_at?: string | null; email_error_code?: string | null; reminder_status?: string | null; reminder_sent_at?: string | null; reminder_error_code?: string | null };
