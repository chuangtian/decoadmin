...
- Remaining: multi-language copy management, colors/corners, redirect behavior, QR code, collection targeting, answer export and Merchant API representation.
...
- Latest combined Deco Reviews automated suite: 86 tests, 598 assertions passed.
